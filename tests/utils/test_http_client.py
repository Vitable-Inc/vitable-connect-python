...
from vitable_connect.core.http_client import (
    AsyncHttpClient,
    HttpClient,
    _build_url,
    _should_retry,
...
from vitable_connect.core.request_options import RequestOptions
...
@patch("vitable_connect.core.http_client.time.sleep", return_value=None)
...
@pytest.mark.asyncio
@patch("vitable_connect.core.http_client.asyncio.sleep", new_callable=AsyncMock)
